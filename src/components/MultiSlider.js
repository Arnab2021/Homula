...
export default function RangeSlider(props) {
    ...
    const min_initVal = props.min;
    const max_initVal = props.max;
    const colorNeutral = "#fff";
    ...
    const initSliders = (height, width) => {
        ...
        // console.log('min_animState',min_animState);
        //console.log('max_animState',max_animState);
        ...
        return PanResponder.create(
            {
                ...
                onPanResponderGrant: () => // When the slider starts moving
                {
                    ...
                    props.onValuesChange(min_animState.displayVal.toString() + '-' + max_animState.displayVal.toString())
                },
